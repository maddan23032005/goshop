        ...
        <div className='mx-6'>
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                ...
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    ...
                    <div
                        onClick={() => router.push('/shop')}
                        className='flex-1 flex items-center justify-between w-full bg-orange-200 rounded-3xl p-6 px-8 group cursor-pointer hover:shadow-md transition'
                    >
                        <div>
                    ...
                    <div
                        onClick={() => router.push('/shop')}
                        className='flex-1 flex items-center justify-between w-full bg-blue-200 rounded-3xl p-6 px-8 group cursor-pointer hover:shadow-md transition'
                    >
                        <div>
